...
<br>
<br>
<div id="main-wrapper" style="background-image: url('assets/uploadImage/Logo/banner3.jpg');
...
<footer class="bg-primary text-white text-center text-lg-start fixed-bottom">
  ...
  Natalia Quinteros Estudiante Ing Informatica Puente Alto Inacap - 2023
  </div>
  <!-- Copyright -->
</footer>
</div>
