...
<div class="page-wrapper">
  ...
  <div class="row page-titles">
    <div class="col-md-5 align-self-center">
      <h3 class="text-primary">Agregar Entrega</h3>
    </div>
    <div class="col-md-7 align-self-center">
      <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="javascript:void(0)">Inicio</a></li>
        <li class="breadcrumb-item active">Agregar Entrega</li>
      </ol>
    </div>
  </div>
      ...
      <div class="col-lg-11" style="    margin-left: 5%;">
              ...
              <form class="form-horizontal" method="POST" id="createOrderForm" action="php_action/order.php" action="php_action/order.php">
                ...
                <div class="form-group">
                  <div class="row">
                    ...
                    <label class="col-sm-2 control-label">No Entrega</label>
                    <div class="col-sm-4">
                      <?php
          ...
          <div class="row">
            ...
            <div class="col-sm-4">
              <select class="form-control" name="paymentStatus" id="paymentStatus">
                ...
                <option value="2">Entrega Parcial</option>
                <option value="3">Entrega Pendiente</option>
              </select>
            </div>

            <label for="clientContact" class="col-sm-2 control-label">Lugar de Entrega</label>
            <div class="col-sm-4">
              <select class="form-control" name="paymentPlace" id="paymentPlace">
                <option value="">~~Seleccionar~~</option>
                <option value="1">Farmacia Central HPH</option>
                <option value="2">Farmacia Publico General</option>
                <option value="2">Envio a Domicilio </option>
                <option value="2">Mermas</option>
              </select>
            </div>
          </div>
        </div>
        <div class="form-group submitButtonFooter">
          <div class="col-sm-offset-2 col-sm-10">
            ...
            <button type="reset" class="btn btn-danger btn-flat m-b-30 m-t-30" onclick="resetOrderForm()"><i class="glyphicon glyphicon-erase"></i> Limpiar</button>
          </div>
        </div>
