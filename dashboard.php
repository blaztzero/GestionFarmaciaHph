                    ...
                    <div class="card" style="    background-color: #f05746 ">
                        <div class="media widget-ten">
                            ...
                            <div class="media-body media-text-right">
                                ...
                                <a href="Order.php">
                                    <p class="m-b-0">Medicamentos Vencidos</p>
                                </a>
                            </div>
                        </div>
                    </div>
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <strong class="card-title">Entregas Recientes de Medicamentos</strong>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><?php if ($row['paymentStatus'] == 1) {
                                                ...
                                                $paymentStatus = "<label class='label label-info' ><h4>Entrega Completa</h4></label>";
                                                echo $paymentStatus;
                                            } else if ($row['payment_status'] == 2) {
                                                $paymentStatus = "<label class='label label-warning'><h4>Entrega Parcial</h4></label>";
                                                echo $paymentStatus;
                                            } else {
                                                $paymentStatus = "<label class='label label-danger'><h4>Entrega Pendiente</h4></label>";
                                                echo $paymentStatus;
                                            } // /els
                                            ?></td>
